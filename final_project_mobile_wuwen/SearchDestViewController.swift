...
extension SearchDestViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        GMSPlacesClient.shared().lookUpPlaceID(googlePlace[indexPath.row].placeID ?? "") { (place, error) in
            if error == nil && place != nil {
                ...
                //                self.navigationController?.popViewController (animated: true)
                print("IIIIIII AMMMM IN DEEEEEST SEARCH")
...
extension SearchDestViewController: UITextFieldDelegate {
